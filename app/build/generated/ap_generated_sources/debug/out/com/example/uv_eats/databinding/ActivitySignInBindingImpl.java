...
public class ActivitySignInBindingImpl extends ActivitySignInBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.TextName, 1);
        sViewsWithIds.put(R.id.TextUser, 2);
        sViewsWithIds.put(R.id.TextEmail, 3);
        sViewsWithIds.put(R.id.TextPassword, 4);
        sViewsWithIds.put(R.id.TextRepitPassword, 5);
        sViewsWithIds.put(R.id.ButtonRegister, 6);
        sViewsWithIds.put(R.id.ButtonReturn, 7);
    }
    // views
    @NonNull
